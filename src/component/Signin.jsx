...
<div className="w-full flex items-center  justify-between h-screen bg-zinc-400">
 <div className="w-1/2 h-full bg-zinc-800 overflow-hidden whitespace-nowrap  ">
<div className='w-screen h-full flex  justify-start items-center'>
<motion.div initial={{x:'-100%'}} animate={{x:"0"}} transition={{repeat:Infinity, ease:"linear", duration:20}} className='h-1/3 w-1/2 bg-slate-300  border-orange-600 border-2' >
 ...
 <div className="w-1/2 h-full bg-zinc-800 ml-[1px] flex items-center justify-center ">

  <div className="w-4/5 border-orange-600 border-2 bg-zinc-400 h-1/2 rounded-lg flex items-center justify-center"> 
...
<form  className='mx-auto'>
       ...
       <input type="email" id='email' placeholder="Email" {...register("email",{required:true})} /></div> 
       <div className="mb-1 border-zinc-700 py-3 px-5  border-[1px] rounded-full"> 
       <label className='mb-3'htmlFor='password'>password:</label>
        <input id='password' type="password" placeholder="Password"  {...register("password",{required:true})} /></div>
       <div className="mb-6 border-zinc-700 py-3 px-5  border-[1px] rounded-full">
         <label className='mb-3' htmlFor='name'>name:</label>
        <input id='name' type="text" placeholder="Name"  {...register("name",{required:true})}/> </div>

        <button className=' border-orange-600 border-2 rounded-full px-5 py-4 mx-6 text-xl' type="button" onClick={handleSubmit(Login)}>
          login
        </button>
